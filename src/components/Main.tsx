...
const Main: React.FC<MainProps> = ({ onLogout }) => {
  return (
    <div
      className="flex bg-gradient-to-br from-black via-gray-900 to-blue-900 relative"
    >
      <NetworkBackground />
      {/* Sidebar */}
      <aside className="w-20 bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl m-[10px] flex flex-col items-center py-6 space-y-12">
        <div className="mb-4 flex flex-col items-center">
          {/* Padding before divider */}
          <div style={{ height: "12px" }} />
          <img src="src/assets/Warden.png" alt="Warden Logo" className="w-12 h-12 mb-2" />
        ...
        <nav className="flex flex-col space-y-4">
          ...
          <button className="p-3 rounded-lg hover:bg-gray-800 text-gray-400 hover:text-white transition-colors">
            ...
            <img 
              ...
              alt="Topology" 
              style={{ width: 30, height: 30, opacity: 0.6 }} // Change opacity here (0 = fully transparent, 1 = fully opaque)
            />
            </button>
          <button className="p-3 rounded-lg hover:bg-gray-800 text-gray-400 hover:text-white transition-colors">
            <img 
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6">
              <div className="flex justify-between items-center mb-2">
                ...
                <img
                  ...
                  alt="Warden Logo"
                  className="w-15 h-15 rounded-full border border-blue-500"
